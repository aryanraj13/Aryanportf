    ...
    <section id="contact" className="section relative">
      <div className="container-px mx-auto max-w-5xl">
        ...
        <motion.p
          ...
          className="text-center text-muted mb-8 max-w-lg mx-auto"
        >
        ...
        >
          ...
          <a
            ...
            className="inline-flex items-center gap-2 text-lg sm:text-xl font-medium text-primary hover:text-hoverGreen transition-colors"
          >
            <FiMail size={20} />
            {profile.email}
          </a>
